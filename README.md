...
<body>
    ...
    <header>
        <div class="tblogo">
            <img src="logo.jpeg" href="home.html" alt="The Baratie Logo">
            ...
            <nav>
                ...
                <a href="index4.html">Administration</a>
           </nav>
    ...
    <section id="features" class="features">
        <div class="feature">
            <img src="img2.png" alt="Stunning Ocean Views">
        ...
        <div class="feature">
            <img src="img3.png" alt="Unique Nautical Ambiance">
        ...
        <div class="feature">
            <img src="img3.png" alt="Signature Seafood">
            <h3>Signature Seafood</h3>
            <p>Savor the freshest catch, beautifully displayed and expertly prepared to celebrate the flavors of <br> the ocean.</p>
        </div>
    </section>

    <footer>
        <p>Designed by : Kathiresh M(24901022)</p>
    </footer>
...
<body>
    ...
    <div class="menu-container">
        ...
        <div class="menu-items">
            <div class="menu-item">
                <img src="img2.jpg" alt="Lobster Bisque">
            ...
            <div class="menu-item">
                <img src="img3.jpg" alt="Grilled Octopus">
                <div class="menu-details">
            ...
            <div class="menu-item">
                <img src="img4.jpg" alt="Shrimp Scampi">
                <div class="menu-details">
                    <h3>Shrimp Scampi</h3>
            ...
            <div class="menu-item">
                <img src="img5.jpg" alt="Bouillabaisse">
                <div class="menu-details">
                    <h3>Bouillabaisse</h3>
            ...
            <div class="menu-item">
                <img src="img6.jpg" alt=" Sushi & Sashimi">
                <div class="menu-details">
                    <h3> Sushi & Sashimi</h3>
            ...
            <div class="menu-item">
                <img src="img8.jpg" alt=" Paella de Mariscos">
                <div class="menu-details">
            ...
            <div class="menu-item">
                <img src="img9.jpg" alt="Crab Cakes">
                <div class="menu-details">
                    <h3>Crab Cakes</h3>
            ...
            <div class="menu-item">
                <img src="img10.jpg" alt="Fish Tacos">
                <div class="menu-details">
                    <h3>Fish Tacos</h3>
            ...
            <div class="menu-item">
                <img src="img11.jpg" alt="Salmon Teriyaki">
                <div class="menu-details">
            ...
            <div class="menu-item">
                <img src="img12.jpeg" alt="Jambalaya">
                <div class="menu-details">
                    <h3>Jambalaya</h3>
            ...
            <div class="menu-item">
                <img src="img13.webp" alt="Chilli Crab">
                <div class="menu-details">
                    <h3>Chilli Crab</h3>
...
<body>
    ...
    <footer>
        <p>Designed by : Kathiresh(24901022)</p>
    </footer>
...
<body>
    ...
    <div class="admin-container">
        ...
        <div class="admin-items">
            ...
            <div class="admin-item">
                <img src="chef.avif" alt="Master Chef">
                <div class="admin-details">
            ...
            <div class="admin-item">
                <img src="assistant.png" alt="Assistant Managing Director">
                <div class="admin-details">
                    <h3>Nami</h3>
...
## OUTPUT:
![alt text](<Screenshot 2025-11-19 102741.png>) 
![alt text](<Screenshot 2025-11-19 102720.png>) 
![alt text](<Screenshot 2025-11-19 102705.png>) 
![alt text](<Screenshot 2025-11-19 102641.png>)
